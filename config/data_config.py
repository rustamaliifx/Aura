...
class DataConfig(BaseSettings):
    ...
    BATCH_SIZE: int = 5000 # Number of records to fetch in each batch 
    PROCESSING_INTERVAL: int = 120 # in seconds 

    # Data processing settings
    COLUMNS_TO_USE: List = ['HA_active_connections', 'HA_backend_current_queue',
